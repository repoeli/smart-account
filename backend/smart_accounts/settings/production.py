"""
Production settings for Smart Accounts Management System.
"""
...
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['smartaccounts.com', 'www.smartaccounts.com'])
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@smartaccounts.com')
